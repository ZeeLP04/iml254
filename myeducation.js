  ...
  // TYPING EFFECT //
  var i = 0;
  var txt = 'Learn to trust the process and do not be afraid to fail every now and then. Treat it as a stepping stone for something better to be gain later in life.';
  var speed = 50;
